    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="#" class="text-gray-600 hover:text-red-600 transition-colors text-sm">
                            Notre mission
                        </a>
                    </li>
                    <li>
        ...
        <div class="border-t border-gray-200 pt-8">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-center gap-6">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-600">
                    <p>© 2026 Marketplace Bétail CI</p>
                ...
                <div class="flex items-center gap-6">
                    ...
                    {{-- Language Selector --}}
                    <button class="flex items-center gap-2 text-sm text-gray-700 hover:text-red-600 transition-colors">
