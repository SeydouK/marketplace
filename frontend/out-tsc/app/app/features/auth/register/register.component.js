...
function RegisterComponent_p_40_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 24);
    i0.ɵɵtext(1, " Confirmation requise. ");
    i0.ɵɵelementEnd();
} }
function RegisterComponent_p_41_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "p", 24);
...
export class RegisterComponent {
    ...
    static { this.ɵfac = function RegisterComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || RegisterComponent)(i0.ɵɵdirectiveInject(i1.FormBuilder), i0.ɵɵdirectiveInject(i2.AuthService), i0.ɵɵdirectiveInject(i3.Router), i0.ɵɵdirectiveInject(i4.ToastService)); }; }
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: RegisterComponent, selectors: [["app-register"]], standalone: false, decls: 48, vars: 13, consts: [[1, "auth-hero"], [1, "hero-copy"], [1, "badge"], [1, "pi", "pi-user-plus"], [1, "subtitle"], [1, "auth-card"], [1, "form", 3, "ngSubmit", "formGroup"], [1, "field"], ["for", "name"], ["id", "name", "type", "text", "formControlName", "name", "placeholder", "Votre nom complet", 1, "text-field"], ["class", "error-text", 4, "ngIf"], ["for", "email"], ["id", "email", "type", "email", "formControlName", "email", "placeholder", "email@exemple.com", 1, "text-field"], ["for", "password"], [1, "password-group"], ["id", "password", "formControlName", "password", "placeholder", "Au moins 6 caracteres", 3, "type"], ["type", "button", "aria-label", "Afficher ou masquer le mot de passe", 1, "eye-btn", 3, "click"], [1, "pi", 3, "ngClass"], ["for", "passwordConfirmation"], ["id", "passwordConfirmation", "formControlName", "passwordConfirmation", "placeholder", "Retapez votre mot de passe", 3, "type"], ["type", "button", "aria-label", "Afficher ou masquer la confirmation du mot de passe", 1, "eye-btn", 3, "click"], ["type", "submit", 1, "primary-submit", 3, "disabled"], [1, "hint"], ["routerLink", "/login"], [1, "error-text"]], template: function RegisterComponent_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtemplate(22, RegisterComponent_p_22_Template, 2, 0, "p", 10)(23, RegisterComponent_p_23_Template, 2, 0, "p", 10);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(24, "div", 7)(25, "label", 13);
            i0.ɵɵtext(26, "Mot de passe");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(27, "div", 14);
            i0.ɵɵelement(28, "input", 15);
            i0.ɵɵelementStart(29, "button", 16);
            i0.ɵɵlistener("click", function RegisterComponent_Template_button_click_29_listener() { return ctx.togglePassword(); });
            i0.ɵɵelement(30, "i", 17);
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(31, RegisterComponent_p_31_Template, 2, 0, "p", 10)(32, RegisterComponent_p_32_Template, 2, 0, "p", 10);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(33, "div", 7)(34, "label", 18);
            i0.ɵɵtext(35, "Confirmation");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(36, "div", 14);
            i0.ɵɵelement(37, "input", 19);
            i0.ɵɵelementStart(38, "button", 20);
            i0.ɵɵlistener("click", function RegisterComponent_Template_button_click_38_listener() { return ctx.togglePasswordConfirmation(); });
            i0.ɵɵelement(39, "i", 17);
            i0.ɵɵelementEnd()();
            i0.ɵɵtemplate(40, RegisterComponent_p_40_Template, 2, 0, "p", 10)(41, RegisterComponent_p_41_Template, 2, 0, "p", 10);
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(42, "button", 21);
            i0.ɵɵtext(43, " Creer mon compte ");
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(44, "p", 22);
            i0.ɵɵtext(45, " Vous avez deja un compte ? ");
            i0.ɵɵelementStart(46, "a", 23);
            i0.ɵɵtext(47, "Se connecter");
            i0.ɵɵelementEnd()()()()();
        } if (rf & 2) {
            i0.ɵɵadvance(12);
